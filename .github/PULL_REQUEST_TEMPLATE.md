...
- [ ] 🎨 **Style** (formatação, sem mudanças na lógica)
- [ ] ♻️ **Refactor** (mudanças no código sem alterar funcionalidade)
...
- [ ] Esta PR não introduz vulnerabilidades de segurança
- [ ] Esta PR corrige uma vulnerabilidade de segurança
...
- [ ] @maintainer (para mudanças críticas)
- [ ] @security-team (para mudanças de segurança)
...
**Obrigado por contribuir para o AutoJoin for SteamGifts! 🎮**

*Lembre-se: PRs menores e focadas são mais fáceis de revisar e têm maior chance de serem aceitas rapidamente.*
